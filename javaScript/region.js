...
const regionObj = {
    ...
    johto:"Much of the overall aesthetic and inspiration for the Johto region comes from traditional Japanese architecture and culture, and the fictional area is inspired by the Kansai region of Japan, which includes Osaka, Kyoto, and Nara. The Kansai region has rich soils, which inspired the berry crop mechanic introduced in this generation of games.",
    hoenn:"Hoenn was a more tropical environment, reflected in many of the types of Pokémon that could be found throughout trainers’ journeys. This game introduced the idea of varying weather patterns, including rainfall, volcanic ash, and bright sunlight. Pokémon like Castform could even react and change form based on the environmental conditions here. Starters in this region included Treecko, Torchic, and Mudkip.",
